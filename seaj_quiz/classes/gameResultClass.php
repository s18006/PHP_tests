...
class gameResultClass extends dbManagerClass {
    ...
    public function firstTableCont($post) {
        ...
        $this -> data_list = self::downloadParams1Row($query_row, 'Tester', 's', 4);
    ...
    public function updateResult() {
        ...
        $upload_list = array('Tester', 'SEA-J', $this -> data_list[4], $this -> data_list[0], $this -> data_list[1], $this -> data_list[2]);
